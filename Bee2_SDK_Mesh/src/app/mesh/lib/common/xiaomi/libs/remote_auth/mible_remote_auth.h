...
#define AUTH_NEW_VERSION			    (1)
#define AUTH_OLD_VERSION			    (2)
#define MIBLE_OLD_REGISTER_AUTH 		0xDE85CA90
#define MIBLE_NEW_REGISTER_AUTH			0x00000015
#define MIBLE_WAIT_T2_ACK_TOKEN			0xFA54AB92
#define MIBLE_BONDING_SUCC_AUTH			0xAC61B130
