...
//rc4
mible_status_t mible_gatts_val_set_rc4(uint8_t mod, uint8_t offset, uint8_t* p_value, uint8_t len);

mible_status_t mible_gatts_notify_or_indicate_rc4(uint8_t mod, uint8_t offset,
