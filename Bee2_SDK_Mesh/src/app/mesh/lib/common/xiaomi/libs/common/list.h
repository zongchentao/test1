...
#define zerotooffset(TYPE, MEMBER) ((size_t) &((TYPE *)0)->MEMBER)
...
#define container_of(ptr, type, member) ({                      \
	...
	(type *)( (char *)__mptr - zerotooffset(type,member) );})
 ...
 * This is useful for implementing queues.
 */
static inline void list_insert_before(struct list_head *_new, struct list_head *before)
{
	__list_add(_new, before, before->next);
}
