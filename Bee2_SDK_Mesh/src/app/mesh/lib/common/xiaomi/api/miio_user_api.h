 ...
 */
static inline uint32_t miio_system_get_utc(void)
{
    return mible_systime_utc_get();
}
 ...
 *@return   systicks in ms.
 */
static inline int miio_system_set_utc(uint32_t utc_time)
{
    return mible_systime_utc_set(utc_time);
}
