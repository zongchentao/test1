...
__WEAK int mible_mesh_device_set_nettx(uint8_t ttl, uint8_t count, uint8_t interval)
{
    return 0;
}

__WEAK int mible_mesh_device_get_nettx(uint8_t *ttl, uint8_t *count, uint8_t *step)
{
    return 0;
}
...
__WEAK int mible_mesh_device_set_seq(uint16_t element, uint32_t seq)
{
    return 0;
}
...
__WEAK int mible_mesh_device_snb_start(bool enable)
{
    return 0;
}
...
__WEAK int mible_mesh_device_get_sub_address(uint16_t *addr, uint16_t max_count)
{
    return 0;
}
