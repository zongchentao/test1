...
#define MIBLE_MESH_MIOT_SCENE_STATE                                 0x00D0 //0xCF038F
#define MIBLE_MESH_MIOT_SCENE_STORE                                 0x00D1 //0xCF038F
#define MIBLE_MESH_MIOT_SCENE_DELETE                                0x00D2 //0xCF038F
#define MIBLE_MESH_MIOT_SCENE_RECALL                                0x00D3 //0xCF038F
#define MIBLE_MESH_MIOT_SCENE_POS_ADD                               0x00D4 //0xCF038F
#define MIBLE_MESH_MIOT_SCENE_POS_DEL                               0x00D5 //0xCF038F
#define MIBLE_MESH_MIOT_DEV_TRACE                                	0x00F0 //0xCF038F
#define MIBLE_MESH_MIOT_DEV_CONFIG_GET                              0x00F1 //0xCF038F
#define MIBLE_MESH_MIOT_DEV_CONFIG_SET                              0x00F2 //0xCF038F
#define MIBLE_MESH_MIOT_DEV_CONFIG_STATUS                        	0x00F3 //0xCF038F
...
/* New Opcode */
#define MIBLE_MESH_MIOT_SPEC_DEV_CONFIG_POWERUP_SEQ                	0x00
#define MIBLE_MESH_MIOT_SPEC_DEV_CONFIG_GROUP_SYNC               	0x01
#define MIBLE_MESH_MIOT_SPEC_DEV_CONFIG_PRE_GROUP_SYNC           	0x02
#define MIBLE_MESH_MIOT_SPEC_DEV_CONFIG_GROUP_ACK                	0x03
#define MIBLE_MESH_MIOT_SPEC_DEV_CONFIG_RELAY                    	0x04
#define MIBLE_MESH_MIOT_SPEC_DEV_CONFIG_NET                      	0x05
#define MIBLE_MESH_MIOT_SPEC_DEV_CONFIG_SCAN                      	0x06
 ...
 */
__PACKED typedef struct {
    uint8_t net_retrans_cnt;
    uint8_t net_retrans_intvlsteps;
} mible_mesh_conf_nettx_set_t;

/**
 * @brief Mesh Config ttl Status event paramater type.
 */
__PACKED typedef struct {
    uint8_t ttl;
} mible_mesh_conf_ttl_set_t;
...
__PACKED typedef struct {
    ...
    __PACKED union{
        ...
        mible_mesh_conf_nettx_set_t     nettx_set;
        mible_mesh_conf_ttl_set_t       ttl_set;
...
__PACKED typedef struct {
    ...
    uint8_t  buff[8];
    uint8_t* p_buf;        /* mesh raw data, see mesh profile 4.3 */
...
typedef enum {
    ...
    MIBLE_MESH_OP_OVERWRITE,
    MIBLE_MESH_OP_DELETE_ALL,
}mible_mesh_op_t;
...
typedef enum {
    ...
    MIBLE_USER_TIMER_POLL_SECOND,
    MIBLE_USER_SCENE_CB_ADD = 0x20,
...
/**
 *@brief    enable/disable secure network beacon.
 *@param    [in] enable : open snb
 *@return   0: success, negetive value: failure
 */
...
/**
 *@brief    add/delete pre-subscription params(can't save in ram).
 *@param    [in] op : add or delete
 *@param    [in] element : model element
 *@param    [in] company_id: company id
 *@param    [in] model_id : model_id
