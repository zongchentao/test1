...
__WEAK void mible_mcu_init(void)
{
}

__WEAK void mible_mcu_deinit(void)
{
}

__WEAK void mible_mcu_send_buffer(const uint8_t *pSend_Buf, uint16_t vCount)
{
}

__WEAK void mible_mcu_send_byte(uint8_t byte)
{
}

__WEAK void mible_mcu_flushinput(void)
{
}

__WEAK PT_THREAD(mible_mcu_recv_bytes(void *bytes, uint16_t req, uint32_t timeout))
{
    return PT_EXITED;
}
