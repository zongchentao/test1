...
static user_cmd_parse_result_t user_cmd_itms(user_cmd_parse_value_t *pparse_value)
{
    bool flag = pparse_value->dw_parameter[0];
    iv_index_test_mode_set(flag);
    return USER_CMD_RESULT_OK;
}

static user_cmd_parse_result_t user_cmd_iis(user_cmd_parse_value_t *pparse_value)
{
...
static user_cmd_parse_result_t user_cmd_nmc(user_cmd_parse_value_t *pparse_value)
{
    nmc_clear();
    return USER_CMD_RESULT_OK;
}

static user_cmd_parse_result_t user_cmd_rplc(user_cmd_parse_value_t *pparse_value)
{
    rpl_clear();
    return USER_CMD_RESULT_OK;
}
...
const user_cmd_table_entry_t mi_cmd_table[] =
{
    ...
    },
    {
        "nmc",
        "nmc\r\n",
        "network message cache list clear\r\n",
        user_cmd_nmc,
    },
    {
        "rplc",
        "rplc\r\n",
        "replay protection list clear\r\n",
        user_cmd_rplc,
    },
    /* MUST be at the end: */
    {
