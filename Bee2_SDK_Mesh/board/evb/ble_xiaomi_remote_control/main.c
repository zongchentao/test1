...
{
    Pad_Config(P4_0, PAD_PINMUX_MODE, PAD_IS_PWRON, PAD_PULL_UP,
                PAD_OUT_DISABLE, PAD_OUT_HIGH);
    Pinmux_Config(P4_0, DWGPIO);

    Pad_Config(P4_1, PAD_PINMUX_MODE, PAD_IS_PWRON, PAD_PULL_UP,
                PAD_OUT_DISABLE, PAD_OUT_HIGH);
    Pinmux_Config(P4_1, DWGPIO);

    Pad_Config(P2_4, PAD_PINMUX_MODE, PAD_IS_PWRON, PAD_PULL_UP,
                PAD_OUT_DISABLE, PAD_OUT_HIGH);
...
void driver_init(void)
{
    ...
    GPIO_MaskINTConfig(GPIO_InitStruct.GPIO_Pin, DISABLE);
    GPIO_INTConfig(GPIO_InitStruct.GPIO_Pin, ENABLE);
    /* key 1 */
    GPIO_InitStruct.GPIO_Pin = GPIO_GetPin(P4_1);
    GPIO_Init(&GPIO_InitStruct);
    ...
    GPIO_INTConfig(GPIO_InitStruct.GPIO_Pin, ENABLE);
    /* key 2 */
    GPIO_InitStruct.GPIO_Pin = GPIO_GetPin(P2_4);
    GPIO_Init(&GPIO_InitStruct);
