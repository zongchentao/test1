...
#ifdef MIBLE_API_SYNC
								if(NULL != gap_wait_seg_handle)
									os_sem_give(gap_wait_seg_handle);
#endif
            }
        }
    ...
    case GAP_CONN_STATE_CONNECTED:
        {
            ...
            param.connect.conn_param.conn_sup_timeout = conn_supervision_timeout;
    ...
    case GAP_CONN_PARAM_UPDATE_STATUS_SUCCESS:
        {
            ...
            param.update_conn.conn_param.slave_latency = conn_slave_latency;
            param.update_conn.conn_param.conn_sup_timeout = conn_supervision_timeout;
...
T_APP_RESULT app_gap_callback(uint8_t cb_type, void *p_cb_data)
{
    ...
    case GAP_MSG_LE_MODIFY_WHITE_LIST:
        ...
        APP_PRINT_INFO1("GAP_MSG_LE_ADV_UPDATE_PARAM: cause 0x%x",
				...
				//APP_PRINT_INFO0("Start advertising ...");
				//le_adv_start();
#ifdef MIBLE_API_SYNC
				if(NULL != gap_wait_seg_handle)
						os_sem_give(gap_wait_seg_handle);
